...
/**
 * Fábrica de validadores específica para designaciones que utiliza reflexión automática.
 * Implementa el patrón Singleton y cache de instancias para optimizar rendimiento.
 * 
 * Convenciones de nomenclatura:
 * - Para validador "fecha" busca clase: unpsjb.labprog.backend.business.validator.designacion.validators.FechaValidator
 * - Para validador "solapamiento" busca clase: unpsjb.labprog.backend.business.validator.designacion.validators.SolapamientoValidator
 */
