/**
 * Configuración de animaciones GSAP para el componente Designaciones
 * Basado en el patrón establecido en personas, divisiones, cargos y parte-diario
 */
export class DesignacionesAnimations {
    ...
    static readonly HOVER_EFFECTS = {
        ...
        // Efecto para botón de nueva designación
        newButton: {
            selector: '.btn-nuevo',
            hoverIn: { 
                y: -3,
    ...
    /**
     * Animaciones específicas para designaciones
     */
    static readonly DESIGNACION_EFFECTS = {
        // Animación para badges de estado (activo/inactivo)
        statusBadges: {
     ...
     */
    static readonly VALIDATION_EFFECTS = {
        ...
        // Animación para validación fallida
        validationError: {
            selector: '.btn-nuevo',
            animation: {
