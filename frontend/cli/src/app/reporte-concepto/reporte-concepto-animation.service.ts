...
export class ReporteConceptoAnimationService {
    ...
    /**
     * Anima la entrada de gráficos
     */
    animateChartsEntrance(container: ElementRef, onComplete?: () => void): void {
        const timeline = this.animationService.executeAnimationSequence(
            container,
            ReporteConceptoAnimations.CHARTS_ENTRANCE
        );
    ...
    setupHoverEffects(container: ElementRef): void {
        ...
        // Configurar hover para contenedores de gráficos
        this.animationService.setupHoverEffects(
            container,
            hoverConfigs.chartContainers.selector,
            hoverConfigs.chartContainers.hoverIn,
            hoverConfigs.chartContainers.hoverOut,
            hoverConfigs.chartContainers.config
        );
