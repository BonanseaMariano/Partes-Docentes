/**
 * Configuración de animaciones GSAP para el componente Cargos
 * Basado en el patrón establecido en personas, divisiones y parte-diario
 */
export class CargosAnimations {
    ...
    static readonly HOVER_EFFECTS = {
        // Efecto para botones de horarios (azules por defecto, gris si están vacíos)
        horariosButtons: {
        ...
        // Efecto para botones vacíos de horarios
        horariosButtonsEmpty: {
        ...
        // Efecto para botón de nuevo cargo
        newButton: {
            selector: '.btn-nuevo',
            hoverIn: {
                y: -3,
    ...
    static readonly POPUP_ENTRANCE = {
        ...
        content: {
            selector: '.popup-container .horarios-container',
            animation: {
                y: 20,
                opacity: 0,
                duration: 0.5,
    ...
    /**
     * Animación para badges de tipo de designación
     */
    static readonly BADGE_ANIMATION = {
        // Animación para badges de tipo
        tipoBadges: {
            selector: '.badge',
            animation: {
                scale: 1.1,
    ...
    /**
     * Animaciones específicas para horarios en popup
     */
    static readonly HORARIOS_EFFECTS = {
        // Animación para grupos de días
        dayGroups: {
            selector: '.dia-grupo',
            animation: {
                y: 20,
        ...
        // Animación para horarios individuales
        horarioItems: {
            selector: '.horario-item',
            animation: {
                x: -20,
                opacity: 0,
                duration: 0.3,
