...
/**
 * Fábrica de validadores específica para cargos que utiliza reflexión automática.
 * Implementa el patrón Singleton y cache de instancias para optimizar rendimiento.
 * 
 * Convenciones de nomenclatura:
 * - Para validador "fecha" busca clase: unpsjb.labprog.backend.business.validator.cargo.validators.FechaValidator
 * - Para validador "tipodesignaciondivision" busca clase: unpsjb.labprog.backend.business.validator.cargo.validators.TipodesignaciondivisionValidator
 */
public class CargoValidatorFactory {
     ...
     * 
     * @param validatorName Nombre del validador (ej: "fecha", "tipodesignaciondivision")
