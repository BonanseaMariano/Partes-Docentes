...
/**
 * Validador específico para el artículo 5A: Enfermedad de corta evolución
...
public class Articulo5AValidator implements ArticuloLicenciaValidator {
    ...
    public void validar(Licencia licencia) throws BusinessLogicException {
        // 1. Verificar que tenga certificado médico (nueva validación)
        ...
        // 2. Verificar límite de días por año (validación existente)
