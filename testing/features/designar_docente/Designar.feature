...
Característica: designar una persona a un cargo docente
  ...
  Esquema del escenario: Designación de persona en cargos NO cubiertos aún en el perído indicado de forma existosa
    ...
    Ejemplos:
      ...
      | 99300000 | Homero      | Manzi        | ESPACIO_CURRICULAR | Tecnología        |   4 |      3 | Mañana |            2023-03-01 |                       |    409 | No se puede crear la designación debido a que ya existe otra idéntica                                          |
      | 99300000 | Homero      | Manzi        | ESPACIO_CURRICULAR | Tecnología        |   4 |      3 | Mañana |            2025-03-01 |            2023-03-01 |    422 | La fecha de inicio no puede ser posterior a la fecha de finalización                                           |
